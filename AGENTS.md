# AGENTS.md — Hinweise für KI-Agenten (gregMod.NoCostShop)

Repo: [https://github.com/mleem97/gregMod.NoCostShop](https://github.com/mleem97/gregMod.NoCostShop) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
